# Generated by Django 3.2.6 on 2021-10-16 02:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bebidas', models.ManyToManyField(to='cart.BebidaVariation')),
                ('postres', models.ManyToManyField(to='cart.PostreVariation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bebida', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.bebidavariation')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='cart.order')),
                ('postre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cart.postrevariation')),
